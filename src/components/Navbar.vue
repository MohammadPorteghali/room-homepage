<template>
  <header>
    <nav>
      <button class="menu" @click="showNav">
      ...
      <ul id="nav-items">
        <button class="menu" @click="hideNav">
...
export default {
  ...
  methods: {
    showNav() {
      document.getElementById('nav-items').style.transform = 'translateY(0)'
    },
    hideNav() {
      document.getElementById('nav-items').style.transform = 'translateY(-14vh)'
    },
  }
}
</script>
